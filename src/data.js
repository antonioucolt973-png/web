...
export const projects = [
  ...
  },
  {
    ...
    categoryLabel: '游戏类',
    type: '3D羽毛球竞技游戏',
    points: ['三维球场 + 竞技对战体验', '支持生涯联赛与快速比赛模式'],
    url: 'http://badminton-3d-game.cjmai.top/',
    image: '/assets/badminton-duel.png',
    alt: '羽毛球对决3D游戏首页预览',
  },
  {
    number: '03',
    ...
    categoryLabel: '游戏类',
    type: '2D弹珠闯关捉妖游戏',
    points: ['国风妖怪题材 + 弹珠闯关玩法', '关卡成长、金币和功绩系统'],
    url: 'https://marble-demon-hunt.cjmai.top/',
    image: '/assets/marble-demon-hunt.png',
    alt: '弹珠捉妖记2D游戏首页预览',
  },
  {
    number: '04',
